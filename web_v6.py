...
def index():
    ...
    <head>
        ...
        <style>
            body { font-family: Arial, sans-serif; margin: 20px; display: flex; flex-direction: column; height: 95vh; }
            .header { margin-bottom: 20px; }
            .content { display: flex; flex-grow: 1; }
            .sidebar { width: 250px; margin-right: 20px; }
            .main { flex-grow: 1; display: flex; flex-direction: column; }
            #json-output, #raw-json { flex-grow: 1; overflow: auto; border: 1px solid #ccc; padding: 10px; }
            #raw-json { white-space: pre-wrap; word-wrap: break-word; display: none; }
